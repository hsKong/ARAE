...
#1204delete
with open('./output/{}/args.json'.format(outf), 'w') as f:
    json.dump(vars(args), f)
#with open("./output/{}/logs.txt".format(outf), 'w') as f:
    ...
    while niter < len(train_data):
        ...
        if niter_global % 100 == 0:
            ...
            autoencoder.noise_radius = \
                autoencoder.noise_radius*noise_anneal
...
#                    ppl = train_lm(eval_path=os.path.join(data_path,
#                                                          "test.txt"),
#                                   save_path="output/{}/"
